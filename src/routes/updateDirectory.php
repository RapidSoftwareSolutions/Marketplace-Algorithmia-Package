...
$app->post('/api/Algorithmia/updateDirectory', function ($request, $response) {
    ...
    if($name = $post_data['args']['acl'])
    {
        $data = $post_data['args']['acl'];
    }
    ...
    try {
        ...
        if(in_array($resp->getStatusCode(), ['200', '201', '202', '203', '204'])) {
            ...
            if(empty($result['contextWrites']['to'])) {
                $result['contextWrites']['to']['status_msg'] = "Directory successfully updated";
            }
        } else {
